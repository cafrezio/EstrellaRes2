                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select class="form-control" name="entrgral" wire:model="entrgral">
                                @for ($i=1; $i <= 20; $i++ )
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" name="entrseg" wire:model="entrseg">
                                @for ($i=0; $i <= 20; $i++ )
                                    <option value="{{ $i }}">{{ $i }}</option>
                                @endfor
                            </select>
                    ...
                    <div class="row">
                        <div class="col"><br>
                            <p>Precio calculado: <b>  {{'$ ' .  number_format(max(0, ($entrgral * $precio * $cant_funciones + 
                            $entrseg * $precio_seg * $cant_funciones))) }}</b></p>
                            
                            <b><label for="importe">Importe :</label></b>
                            <input type="number" class="form-control" name="importe" value="{{max(0, ($entrgral * $precio * $cant_funciones + $entrseg * $precio_seg * $cant_funciones)) }}" wire:model="importe">
                        ...
                        <div class="col">
                            ...
                            <span style="text-align: center"><h3>Total:<b>  
                                @php
                                    if(is_null($importe) || $importe ==""){
                                        $val =  '$ ' .  number_format(max(0, ($entrgral * $precio * $cant_funciones + $entrseg * $precio_seg * $cant_funciones)));
                                    }else{
