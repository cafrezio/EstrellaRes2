                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" name="telefono"
                            placeholder="Sin 0 y sin 15 Ej: 1160208707" required wire:model="tel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"><br>
                        <span style="text-align: right">
                            <h3>Total: <b> {{'$ ' . number_format(max(0, ($entr_gral * $precio * $cant_funciones +
                                    $entr_seg * $evento->precio_seg * $cant_funciones))) }}</b></h3>
                        </span>
                    </div>
                </div>
